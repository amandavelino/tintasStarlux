...
<main class="ss-internas page-representantes">
    ...
    <div class="container">
        ...
        <div class="ss-row">
            ...
            <div class="box-representante">
                ...
                <div class="box-representantes">
                    ...
                    <div id="paraiba" class="box-estado">
                        ...
                        <ul class="lista-representantes">

                            <li>
                                <h4>João Pessoa e Brejo</h4>
                                <p>
                                    <strong>José Carlos</strong><br>
                                    <strong>Telefone: </strong> (83) 99372-9107 / 98844-9107<br>
                                    <strong>E-mail: </strong> jcabrepresentacoes@gmail.com
                                </p>
                            </li>

                            <li>
                                <h4>Campina Grande e Sertão</h4>
                                <p>
                                    <strong>Evaldo</strong><br>
                                    <strong>Telefone: </strong> (83) 99111-3150 / 98888-7343<br>
                                    <strong>E-mail: </strong> evaldorep@gmail.com
                                </p>
                            </li>                        
                    ...
                    <div id="pernambuco" class="box-estado">
                        ...
                        <ul class="lista-representantes">
                            ...
                            <li>
                                <h4>Recife</h4>
                                <p>
                                    <strong>Maria Azevedo</strong><br>
                                    <strong>Telefone: </strong> (83) 99222-8150 / 97390-2057<br>
                                    <strong>E-mail: </strong> m.azevedo@gmail.com
                                </p>
                            </li>
                            ...
                            <li>
                                <h4>Olinda</h4>
                                <p>
                                    <strong>Marcos Antônio</strong><br>
                                    <strong>Telefone: </strong> (83) 99333-2255 / 97889-5587<br>
                                    <strong>E-mail: </strong> m.antonio@gmail.com
                                </p>
                            </li>                        
            ...
            <!-- end .box-representante -->

            <div class="box-representante">

                <?php 
                    //Quando listar os representantes, usar a classe hasRepresentante no link do mapa abaixo
                    //O usuário só irá clicar no estado se houver representante para aquele estado.
                ?>

                <div id="mapa-representantes">

                    <svg version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%" height="580px" viewBox="0 0 450 460" enable-background="new 0 0 450 460" xml:space="preserve">
                        <g>
                        ...
                        <a xlink:href="#pernambuco" class="hasRepresentante">
                        ...
                        <a xlink:href="#paraiba" class="hasRepresentante">
                            <title>Paraíba</title>
